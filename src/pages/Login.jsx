          ...
          <div className="bg-forge-900/40 border border-forge-800/50 rounded-2xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                className="w-full group inline-flex items-center justify-center gap-2 bg-ember-500 hover:bg-ember-400 text-forge-950 font-medium px-4 py-2.5 rounded-xl transition-all disabled:opacity-60 shadow-[0_0_20px_rgba(245,158,40,0.12)] hover:shadow-[0_0_28px_rgba(245,158,40,0.2)] text-sm"
              >
