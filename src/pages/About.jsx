            ...
            <div className="relative mb-24 overflow-hidden rounded-2xl border border-forge-800/50 bg-forge-900/30">
              <div className="absolute top-0 right-0 w-96 h-96 opacity-10">
                <div
                  ...
                  style={{
                    background:
                      'radial-gradient(circle, rgba(245,158,40,0.4) 0%, transparent 70%)',
                  }}
                />
              </div>
            ...
            <ScrollReveal>
              <div>
                ...
                <a
                  ...
                  className="group inline-flex items-center gap-2 bg-ember-500 hover:bg-ember-400 text-forge-950 font-medium px-6 py-3 rounded-xl transition-all text-sm shadow-[0_0_20px_rgba(245,158,40,0.12)] hover:shadow-[0_0_28px_rgba(245,158,40,0.2)]"
                >
                  Get Directions
