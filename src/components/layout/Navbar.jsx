  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 h-16 md:h-20 flex items-center justify-between">
        ...
        >
          <div className="w-9 h-9 bg-ember-500/15 rounded-lg flex items-center justify-center transition-all duration-300 group-hover:bg-ember-500/25 group-hover:shadow-[0_0_20px_rgba(245,158,40,0.25)]">
        ...
        <div className="hidden md:flex items-center gap-5">
          ...
          {user ? (
            ...
            <Link
              to="/login"
              className="group inline-flex items-center gap-2 bg-ember-500 hover:bg-ember-400 text-forge-950 text-xs font-mono font-semibold tracking-wider uppercase px-5 py-2.5 rounded-lg transition-all shadow-[0_0_20px_rgba(245,158,40,0.15)] hover:shadow-[0_0_28px_rgba(245,158,40,0.25)]"
